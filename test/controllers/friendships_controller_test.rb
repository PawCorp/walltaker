...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference("Friendship.count") do
      post friendships_url, params: { friendship: { receiver_id: @friendship.receiver_id, sender_id: @friendship.sender_id } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { receiver_id: @friendship.receiver_id, sender_id: @friendship.sender_id } }
