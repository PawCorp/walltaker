...
class LinksController < ApplicationController
  ...
  def log_presence
    if request.format == :json
      ...
      @link.last_ping_user_agent = @link.last_ping_user_agent + ' ' + request.headers['Wallpaper-Engine-Client'] if @link.last_ping_user_agent && request.headers['Wallpaper-Engine-Client']
      @link.save
    end
  end
end
